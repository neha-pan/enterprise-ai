...
export function Home() {
  const [selectedTab, setSelectedTab] = useState('Cowork');
            ...
            <div className="flex items-start gap-4 flex-1">
              <div>
                ...
                <p 
                  ...
                  style={{ color: 'var(--text-primary)', fontWeight: 'var(--font-weight-normal)' }}
                >
                  Looks like you're handling Sales for the North region
                </p>
              </div>
            </div>
          </div>
