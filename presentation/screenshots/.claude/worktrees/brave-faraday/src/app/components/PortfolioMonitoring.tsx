      ...
      >
        <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 py-6 flex flex-col gap-8">
          ...
          <div className="flex justify-center pt-4">
            <SegmentedControl
              options={['Portfolio', 'Risk Analysis', 'Reports']}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {metrics.map((metric, index) => (
              ...
              >
                <div 
                  style={{ 
                    color: metric.trend === 'up' ? '#4ADE80' :
                           metric.trend === 'warning' ? '#F59E0B' :
                ...
                <span
                  ...
                  style={{
                    color: metric.change.startsWith('+') && metric.trend === 'up' ? '#4ADE80' :
                           metric.change.startsWith('+') ? '#F59E0B' :
                           '#4ADE80'
                  }}
                >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex items-center gap-1">
                        ...
                        >
                          <div 
                            ...
                            style={{ 
                              ...
                              backgroundColor: account.riskScore >= 80 ? '#4ADE80' :
                                               account.riskScore >= 60 ? '#F59E0B' :
                                               '#EF4444'
                            }}
                          />
                        </div>
                        <span 
                          ...
                          style={{ 
                            color: account.riskScore >= 80 ? '#4ADE80' :
                                   account.riskScore >= 60 ? '#F59E0B' :
                                   '#EF4444'
                          }}
                        >
