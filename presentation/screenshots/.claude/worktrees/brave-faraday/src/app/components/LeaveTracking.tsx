...
export function LeaveTracking() {
  const [selectedTab, setSelectedTab] = useState('Leave Tracker');
  ...
  const leaveBalance = [
    { type: 'Casual Leave', available: 8, total: 12, color: '#60A5FA' },
    { type: 'Sick Leave', available: 6, total: 10, color: '#4ADE80' },
    { type: 'Privilege Leave', available: 12, total: 15, color: '#F59E0B' },
    { type: 'Comp Off', available: 2, total: 5, color: '#A78BFA' },
  ];
      ...
      >
        <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 py-6 flex flex-col gap-8">
          ...
          <div className="flex justify-center pt-4">
            <SegmentedControl
              options={['Leave Tracker', 'Team Calendar', 'History']}
