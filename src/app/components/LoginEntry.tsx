...
const DEMO_USERS: DemoUser[] = [
  {
    email: 'rahul.ved@bajaj.finserv.in',
    name: 'Rahul Ved',
    initials: 'RV',
    role: 'DMS',
  ...
  {
    email: 'roshni.kale@bajaj.finserv.in',
    name: 'Roshni Kale',
    initials: 'RK',
    role: 'HR',
...
export function LoginEntry() {
  ...
  const handlePasswordSubmit = (e: React.FormEvent) => {
    ...
    if (emailLower === 'rahul.ved@bajaj.finserv.in' || emailLower === 'rahul.ved@gmail.com') {
      navigate('/biometric-setup');
    } else if (emailLower === 'rita.sharma@bajaj.finserv.in') {
      navigate('/employee-home');
    } else if (emailLower === 'rahul.shah@bajaj.finserv.in') {
      navigate('/b2b-home');
    ...
    >
      ...
      >
        <svg width="101" height="42" viewBox="0 0 67 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_5331_7885)">
      ...
      <div className="w-full max-w-md px-6 py-12 flex flex-col items-center gap-12">
        ...
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <p className="text-lg" style={{ color: 'var(--text-secondary)', fontWeight: 400 }}>
        ...
        >
          <h2 className="text-2xl mb-6" style={{ color: 'var(--text-primary)', fontWeight: 500 }}>
            Log in
          </h2>

          <form onSubmit={handleSubmit} className="flex flex-col gap-4">

            {/* Email input + chevron dropdown */}
            <div className="relative" ref={dropdownRef}>
              ...
              {step === 'email' && (
                <button
                  ...
                  className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-150"
                  style={{
                    color: dropdownOpen ? 'var(--brand-blue)' : 'var(--text-secondary)',
                    background: dropdownOpen ? 'rgba(37,99,235,0.08)' : 'transparent',
                    border: 'none',
                    cursor: 'pointer',
                  }}
                  onMouseEnter={(e) => {
                  ...
                  {DEMO_USERS.map((user, i) => (
                    ...
                    >
                      ...
                      <span
                        ...
                        style={{
                          color: isDark ? user.badgeDarkColor : user.badgeColor,
                          backgroundColor: user.badgeBg,
                          border: `1px solid ${user.badgeBg.replace('0.08', '0.2')}`,
                        }}
                      >
                        {user.role}
                      </span>
            ...
            >
              ...
              <button
                ...
                style={{ color: 'var(--text-secondary)', background: 'none', border: 'none', padding: '4px', cursor: 'pointer', display: 'flex', alignItems: 'center' }}
            ...
            <button
              ...
              style={{ backgroundColor: 'var(--brand-blue)', color: '#ffffff', fontSize: '16px', fontWeight: 500, border: 'none', outline: 'none' }}
              onMouseEnter={(e) => {
