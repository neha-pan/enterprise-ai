...
export function AppHeader({ onLeftToggle, onRightToggle }: AppHeaderProps) {
  const hasPanels = !!(onLeftToggle || onRightToggle);
  ...
  return (
    <header
      className="relative z-20 w-full flex items-center gap-2 px-4 sm:px-6 shrink-0"
      style={{
        height: '80px',
    ...
    >
      ...
      {onLeftToggle ? (
        <button
          ...
          className="lg:hidden flex items-center justify-center w-9 h-9 rounded-lg shrink-0 hover:opacity-70 transition-opacity"
      ...
      {/* Logo */}
      <div className={hasPanels ? 'flex-1 flex justify-center lg:justify-start' : ''}>
        <svg width="101" height="42" viewBox="0 0 67 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g clipPath="url(#clip0_appheader_logo)">
          ...
          <defs>
            <clipPath id="clip0_appheader_logo">
      ...
      <div className="ml-auto flex items-center gap-2 shrink-0">
        ...
        {onRightToggle ? (
          <button
            ...
            className="xl:hidden flex items-center justify-center w-9 h-9 rounded-lg hover:opacity-70 transition-opacity"
            style={{ color: 'var(--text-secondary)' }}
